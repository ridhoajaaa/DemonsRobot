...
@idzcmd(command="pvpaste", pass_args=True)
def paste(update: Update, context: CallbackContext):
    ...
    message.reply_text(
        txt, disable_web_page_preview=True, parse_mode=ParseMode.MARKDOWN
    )
