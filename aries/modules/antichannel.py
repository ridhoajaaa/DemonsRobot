...
from aries.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from aries.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel

@idzcmd(command="antichannelmode", group=100)
...
@idzmsg(Filters.chat_type.groups, group=110)
