...
import aries.modules.sql.antilinkedchannel_sql as sql
from aries import TOKEN, dispatcher
from aries.modules.helper_funcs.anonymous import AdminPerms, user_admin
from aries.modules.helper_funcs.chat_status import bot_admin, bot_can_delete
from aries.modules.helper_funcs.chat_status import user_admin as u_admin
from aries.modules.helper_funcs.decorators import idzcmd, idzmsg
from aries.modules.sql import acm_sql


@idzcmd(command="antilinkedchan", group=112)
@bot_can_delete
...
@idzmsg(Filters.is_automatic_forward, group=111)
...
@idzcmd(command="antichannelpin", group=114)
@bot_admin
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
❂ `/antilinkedchannel` <on/off>*:* Makes demonsrobot automatically delete linked channel posts from groups
❂ `/antichannelpin` <on/off>*:* demonsrobot automatically unpin linked channel posts from chatroom
"""
