...
from aries.modules.helper_funcs.chat_status import user_admin_no_reply, user_can_ban
...
from aries.modules.log_channel import gloggable, loggable


@idzcmd(command=["ban", "sban", "dban"], pass_args=True)
@connection_status
@bot_admin
@can_restrict
