...
from aries.modules.helper_funcs.admin_rights import user_can_ban
...
× /gban <userhandle>: Global Banned, (via handle, or reply).
× /gmute <userhandle>: Global Mutting, (via handle, or reply).
