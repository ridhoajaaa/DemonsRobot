...
import aries.modules.helper_funcs.git_api as api
import aries.modules.sql.github_sql as sql
...
@idzcmd(command="git", admin_ok=True)
...
@idzcmd(command="fetch", admin_ok=True)
...
@idzcmd(command="changelog", admin_ok=True)
...
@idzcmd(command="listrepo", admin_ok=True)
...
@idzcmd(command="gitver", admin_ok=True)
