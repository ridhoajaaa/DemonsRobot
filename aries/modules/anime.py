...
from aries import OWNER_ID, REDIS, dispatcher, pgram
from aries.modules.disable import DisableAbleCommandHandler
from aries.modules.helper_funcs.alternate import typing_action
from aries.modules.helper_funcs.chat_status import callbacks_in_filters
...
FVRT_CHAR_HANDLER = DisableAbleCommandHandler(
    ["characterlist", "fcl", "mywaifus"], fvrtchar, run_async=True
)
