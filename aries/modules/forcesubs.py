...
def config(client, message):
    ...
    if user.status == "creator" or user.user.id in DEV_USERS:
        chat_id = message.chat.id
...
__help__ = """
🔘 *Force Subscribe:*
⇝ Aries can mute members who are not subscribed your channel until they subscribe
